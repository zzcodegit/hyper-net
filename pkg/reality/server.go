// Package reality интегрирует Xray REALITY (маскировка под реальный HTTPS, сокрытие сервера).
// Серверная часть использует github.com/xtls/reality; клиентская сторона — в планах (совместима с Xray-клиентами).
package reality
